...
week_dict_ch = ['周一','周二','周三','周四','周五','周六','周日',]
...
class Date_my(object):
	...
	def p(self):
		print(date.year, 'year', date.month, 'month', date.day, 'day', week_en[int(date.week)])
...
def getWeekValues(week, chinese=True):
	return week_dict_ch[week] if chinese else week_en[week]
